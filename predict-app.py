...
Gender = st.sidebar.number_input('Gender: Male (1) Female (0)').round(0)
Married = st.sidebar.number_input('Married: Yes (1) No (0)').round(0)
Dependents = st.sidebar.number_input('Dependents: 1/0/2/3').round(0)
Education = st.sidebar.number_input('Education: Graduate (0) Not Graduate (1)').round(0)
Self_Employed = st.sidebar.number_input('Self_Employed: No (0) Yes (1)').round(0)
ApplicantIncome = st.sidebar.number_input('ApplicantIncome: ').round(0)
CoapplicantIncome = st.sidebar.number_input('CoapplicantIncome: ').round(0)
LoanAmount = st.sidebar.number_input('LoanAmount: ').round(0)
Loan_Amount_Term = st.sidebar.number_input('Loan_Amount_Term: ').round(0)
Credit_History = st.sidebar.number_input('Credit_History: ').round(0)
Property_Area = st.sidebar.number_input('Property_Area: Rural (0) Urban (2) Semiurban (1)').round(0)
