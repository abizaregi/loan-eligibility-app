...
Gender = st.sidebar.round(number_input('Gender: Male (1) Female (0)'), 0)
Married = st.sidebar.round(number_input('Married: Yes (1) No (0)'), 0)
Dependents = st.sidebar.round(number_input('Dependents: 1/0/2/3'), 0)
Education = st.sidebar.round(number_input('Education: Graduate (0) Not Graduate (1)'), 0)
Self_Employed = st.sidebar.round(number_input('Self_Employed: No (0) Yes (1)'), 0)
ApplicantIncome = st.sidebar.round(number_input('ApplicantIncome: '), 0)
CoapplicantIncome = st.sidebar.round(number_input('CoapplicantIncome: '), 0)
LoanAmount = st.sidebar.round(number_input('LoanAmount: '), 0)
Loan_Amount_Term = st.sidebar.round(number_input('Loan_Amount_Term: '), 0)
Credit_History = st.sidebar.round(number_input('Credit_History: '), 0)
Property_Area = st.sidebar.round(number_input('Property_Area: Rural (0) Urban (2) Semiurban (1)'), 0)
